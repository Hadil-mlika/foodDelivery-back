...
public class FoodCatalogueService {
    ...
    public FoodCataloguePage fetchFoodCatalogPageDetails(Integer restaurantId) {
        ...
        Restaurant restaurant =fetchRestaurantsDetailsFromRestaurantMS(restaurantId);
    ...
    private Restaurant fetchRestaurantsDetailsFromRestaurantMS(Integer restaurantId) {
